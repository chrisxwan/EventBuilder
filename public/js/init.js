/*
	...
	*/
	...
	/*copied from danielColorGrid.js*/        
	var gridHeight = 10; /** starting size **/
	var gridWidth= 3;

	$(document).ready(function () {
		create_grid(gridHeight, gridWidth);
		rand();
		trace();
